...
## * TODO
## add the possibility to create an account ! or maybe not ?
## if not a list of all people who want to access is needed
    ...
    div(id = "loginpage",
        ...
        wellPanel(
            ...
            div(
                ...
                br(),
                br(),
                tags$code("test user : myuser1  test pass: mypass1"))))
